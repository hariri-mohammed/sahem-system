...
@section('content')
    <div class="main-content">
        <div class="container">
            <a href="{{ route('supervisor.profile') }}" class="back-btn"><i class="fas fa-arrow-right"></i> العودة إلى الملف
                الشخصي</a>
            ...
            @endif
            <form id="profileEditForm" action="{{ route('supervisor.profile.edit') }}" method="POST">@csrf
                @method('PUT')
                ...
                <div class="profile-info">
                    <div class="info-item">
                        <div class="info-group">
                            ...
                            <input type="text" name="full_name" class="info-value"
                                value="{{ old('full_name', $supervisor->full_name) }}" required>
                        </div>

                        <div class="info-group">
                            <div class="info-label"><i class="fas fa-user-tag"></i><span>اسم المستخدم</span></div>
                            <input type="text" name="username" class="info-value"
                                value="{{ old('username', $supervisor->username) }}" required>
                        </div>

                        <div class="info-group">
                            <div class="info-label"><i class="fas fa-envelope"></i><span>البريد الإلكتروني</span>
                            </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-group">
                            <div class="info-label"><i class="fas fa-lock"></i><span>كلمة المرور الجديدة</span>
                            </div>
                        ...
                        <div class="modal-content" style="font-family: 'Tajawal', sans-serif;">
                            ...
                            <div class="modal-footer justify-content-center border-0">
                                ...
                                <button type="button" class="btn btn-primary px-4"
                                    onclick="document.getElementById('profileEditForm').submit();">تأكيد
                                    الحفظ</button>
                            </div>
                        </div>
                    </div>
